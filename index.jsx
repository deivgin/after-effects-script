...
//Generate project
var myComp = app.project.items.addComp("myComp", compWidth, compHeight, aR, compDuration, compFPS);
	  myComp.openInViewer();

//background
var background = myComp.layers.addSolid(colWhite, "background", compWidth, compHeight, aR, compDuration);

{
    ...
    //Jump height
    var jumpHeightController = mainController.Effects.addProperty("ADBE Slider Control");
    ...
    //Jump period
    var jumpPeriodController = mainController.Effects.addProperty("ADBE Slider Control");
    ...
    //Toggle dropshadow
    var dropShadowToggle = mainController.Effects.addProperty("ADBE Checkbox Control");
		    dropShadowToggle.name = ("Toggle dropshadow");
		    dropShadowToggle.property("Checkbox").setValue(false);

    //Dropshadow distance
    var dropshadowDistance = mainController.Effects.addProperty("ADBE Slider Control");
...
//spinner
{
    ...
    var spinnerContent = spinner.property("Contents").addProperty("ADBE Vector Group");
		    spinnerContent.name = ("Ellipse 1");
    var spinnerGroup1 = spinner.property("Contents").property("Ellipse 1");
    //Add Ellipse
    var spinnerEllipse1 = spinnerGroup1.property("Contents").addProperty("ADBE Vector Shape - Ellipse");
		    spinnerEllipse1.property("Size").setValue([900, 900]); //Set Size
    //Stroke
    var spinnerEllipseStroke = spinnerGroup1.property("Contents").addProperty("ADBE Vector Graphic - Stroke");
    ...
    //Trim Paths
    var spinnerEllipseTrimPaths = spinnerGroup1.property("Contents").addProperty("ADBE Vector Filter - Trim");
		    spinnerEllipseTrimPaths.property("Start").expression ='''ease(time, 1, 2, 0, 10);''';
		    spinnerEllipseTrimPaths.property("End").expression ='''ease(time, 0, 2, 0, 20);''';
		    spinnerEllipseTrimPaths.property("Offset").expression ='''easeIn(time, 0, thisComp.duration, 0, 360 * thisComp.duration);''';
...
//outer spinner
{
    ...
    var outerSpinnerContent = outerSpinner.property("Contents").addProperty("ADBE Vector Group");
		    outerSpinnerContent.name = ("Ellipse 1");
    var outerSpinnerGroup1 = outerSpinner.property("Contents").property("Ellipse 1");
    //Add Ellipse
    var outerSpinnerEllipse1 = outerSpinnerGroup1.property("Contents").addProperty("ADBE Vector Shape - Ellipse");
		    outerSpinnerEllipse1.property("Size").setValue([900, 900]); //Set Size
    //Stroke
    var outerSpinnerEllipseStroke = outerSpinnerGroup1.property("Contents").addProperty("ADBE Vector Graphic - Stroke");
...
//scooter
{
    ...
    var scooterDropShadow = scooter.Effects.addProperty("ADBE Drop Shadow");
		    scooterDropShadow.property("Opacity").expression ='''if(thisComp.layer("Main controller").effect("Toggle dropshadow")("Checkbox") == 1) {50} else {0};''';
		    scooterDropShadow.property("Distance").expression ='''thisComp.layer("Main controller").effect("Dropshadow distance")("Slider");''';

    //create shape groups
    var frameContent = scooter.property("Contents").addProperty("ADBE Vector Group");
    var leftWheelContent = scooter.property("Contents").addProperty("ADBE Vector Group");
    var rightWheelContent = scooter.property("Contents").addProperty("ADBE Vector Group");

    //Frame
    var frame = scooter.property("Contents").property("Group 1");
		    frame.name = ("frame");
    var framePath = frame.property("Contents").addProperty("ADBE Vector Shape - Group");
    ...
    //frame stroke
    var frameStroke = frame.property("Contents").addProperty("ADBE Vector Graphic - Stroke");
    ...
    //left wheel ellipse
    var leftWheelEllipse = leftWheel.property("Contents").addProperty("ADBE Vector Shape - Ellipse");
		    leftWheelEllipse.property("Size").setValue([108, 108]);
    //left wheel stroke
    var leftWheelStroke = leftWheel.property("Contents").addProperty("ADBE Vector Graphic - Stroke");
    ...
    //right wheel ellipse
    var rightWheelEllipse = rightWheel.property("Contents").addProperty("ADBE Vector Shape - Ellipse");
		    rightWheelEllipse.property("Size").setValue([108, 108]);
    //right wheel stroke
    var rightWheelStroke = rightWheel.property("Contents").addProperty("ADBE Vector Graphic - Stroke");
    ...
    //scooter animation
        scooter.property("Transform").property("Position").expression =
          ...
          '''if(time > delay){
            surface = [960, 540];
            jumpHeight = thisComp.layer("Main controller").effect("Jump height")("Slider");
            jump = [960, jumpHeight];
            period = thisComp.layer("Main controller").effect("Jump period")("Slider");	
            t = time % (period * 2); 
            if (t > period) t = 2 * period - t; 
            linear(Math.sin(t * Math.PI / period), 0, 1, surface, jump)
            }else easeOut(time, 0, delay, [300,540],[960,540]);''';
...

{
    ...
    var scooterMaskContent = scooterMask.property("Contents").addProperty("ADBE Vector Group");
		    scooterMaskContent.name = ("Ellipse 1");
    var scooterMaskGroup1 = scooterMask.property("Contents").property("Ellipse 1");
    //Add Ellipse
    var scooterMaskEllipse1 = scooterMaskGroup1.property("Contents").addProperty("ADBE Vector Shape - Ellipse");
		    scooterMaskEllipse1.property("Size").setValue([820, 820]); //Set Size
    //Fill
    var scooterMaskFill = scooterMask.property("Contents").addProperty("ADBE Vector Graphic - Fill");
...

{
    ...
    var speedLines = myComp.layers.addShape();
        ...
        '''jumpStart = ''' + jumpDelay + ''';''' +
          '''visible = jumpStart + framesToTime(5);
          ease(time, jumpStart, visible, 0, 100);''';
    ...
    var speedLinesDropshadow = speedLines.Effects.addProperty("ADBE Drop Shadow");
      ...
      '''if(thisComp.layer("Main controller").effect("Toggle dropshadow")("Checkbox") == 1) {50} else {0};''';
        speedLinesDropshadow.property("Distance").expression ='''thisComp.layer("Main controller").effect("Dropshadow distance")("Slider");''';
    //create shape groups
    var topLineContent = speedLines.property("Contents").addProperty("ADBE Vector Group");
    var BottomLineContent = speedLines.property("Contents").addProperty("ADBE Vector Group");

    //Top Line
    var topLine = speedLines.property("Contents").property("Group 1");
		    topLine.name = ("top line");
    var topLinePath = topLine.property("Contents").addProperty("ADBE Vector Shape - Group");
    ...
    //top stroke
    var topLineStroke = topLine.property("Contents").addProperty("ADBE Vector Graphic - Stroke");
    ...
    //top trimp path
    var topLineTrimPath = topLine.property("Contents").addProperty("ADBE Vector Filter - Trim");
        topLineTrimPath.property("End").expression ='''content("bottom line").content("Trim Paths 1").end.valueAtTime(time -0.1);''';

    //Bottom Line
    var bottomLine = speedLines.property("Contents").property("Group 2");
		    bottomLine.name = ("bottom line");
    var bottomLinePath = bottomLine.property("Contents").addProperty("ADBE Vector Shape - Group");
    ...
    //bottom stroke
    var bottomLineStroke = bottomLine.property("Contents").addProperty("ADBE Vector Graphic - Stroke");
    ...
    //bottom trim path
    var bottomLineTrimPath = bottomLine.property("Contents").addProperty("ADBE Vector Filter - Trim");
...
//color controller
{
    ...
    //Background
    var backgroundColor = colorController.Effects.addProperty("ADBE Color Control");
    ...
    var bgFill = background.Effects.addProperty("ADBE Fill");
		    bgFill.property("Color").expression ='''thisComp.layer("Color controller").effect("Background")("Color");''';
    ...
    var logoFill = scooter.Effects.addProperty("ADBE Fill");
		    logoFill.property("Color").expression ='''thisComp.layer("Color controller").effect("Logo")("Color");''';

    //Outer spinner
    var outerSpinnerColor = colorController.Effects.addProperty("ADBE Color Control");
    ...
    var outerFill = outerSpinner.Effects.addProperty("ADBE Fill");
		    outerFill.property("Color").expression ='''thisComp.layer("Color controller").effect("Outer spinner")("Color");''';
    ...
    var spinnerFill = spinner.Effects.addProperty("ADBE Fill");
		    spinnerFill.property("Color").expression ='''thisComp.layer("Color controller").effect("Spinner")("Color");''';
    ...
    var linesFill = speedLines.Effects.addProperty("ADBE Fill");
		    linesFill.property("Color").expression ='''thisComp.layer("Color controller").effect("Lines")("Color");''';
